...
<div id="main">
  <h2>Lista de reporteros</h2>
  <p>Se muestra la lista de reporteros activos actuales.</p>
    ...
    <table class="table table-image">
      <thead>
        <tr>
          ...
          <th scope="col">Eliminar reportero</th>
        </tr>
      </thead>
      <tbody>
...
<?php
$sql = "CALL sp_reportero('R','null','null','null','null','null','null','null','null','null','null','null')";
 ...
 while($row = mysqli_fetch_array($result)){
    echo'<tr>
          ...
          <td><a href="AdminEliminarReportero.php?id=' . $row['id_usuario'] . '&user=' . $iduserx . '" class="btn btndeleted"> <i class="fa fa-trash fa-fw"></td>
        </tr>';
}
