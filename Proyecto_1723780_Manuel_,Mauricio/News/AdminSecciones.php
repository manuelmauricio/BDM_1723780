...
<div id="main">
  <h2>Secciones</h2>
  <p>Lista de seccienos en la que se agrupan las noticias.</p>
...
$sql = "CALL sp_seccion('$db_selectsection','null','null','null','null','null','null')";
 ...
 while($row = mysqli_fetch_array($result)){
    echo'<tr>
          ...
          <td>  <hr class="categhr" style="border:  16px solid ' . $row['color'] . '; "></td>
          <td><a href="AdminModificarSeccion.php?id=' . $row['id_seccion'] . '&user=' . $iduserx . '" class="btn btnbackend"> <i class="fa fa-edit fa-fw"></td>
          <td><a href="AdminEliminarSeccion.php?id=' . $row['id_seccion'] . '&user=' . $iduserx . '" class="btn btndeleted"> <i class="fa fa-trash fa-fw"></td>
    </tr>';
}
...
?>  
    <tr>
          ...
          <td></td>
          <td></td>
       <?php  echo'    <td><a href="AdminNuevaSeccion.php?user=' . $iduserx . '" class="btn btnbackend"> <i class="fa fa-plus fa-fw"></i>Nueva sección</td>';?>  
    </tr>
