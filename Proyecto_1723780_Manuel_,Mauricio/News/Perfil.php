...
<div class="text-center" >
  <h1 style="color:  #2F435E; font-size: 400%; font-weight: 300;" ><?php echo $u_nombre; echo '&nbsp;'; echo $u_apellido; ?></h1>

  <div class="col-xs-12" style="height:15px;"></div>


<?php echo  '<img src="data:image/jpg;base64,'.base64_encode($u_foto).'" alt="logo"  width="50%" height="50%" >'; ?>

<p><i class="fa fa-user fa-fw"></i> &nbsp; <?php echo $u_username; ?></p>
<p><i class="fa fa-envelope fa-fw"></i> &nbsp; <?php echo $u_correo;?></p>
<p><i class="fa fa-phone fa-fw"></i> &nbsp; <?php echo $u_telefono;?></p>


<?php echo  '  <div class="col-xs-12" style="height:25px;"></div>
  
 <a type="button" href="Configuración.php?user=' . $iduserx . '" class="btn btnconfig"><i class="fa fa-edit fa-fw"></i>&nbsp; Editar Perfil</a>
 <a type="button" href="MeGusta.php?user=' . $iduserx . '" class="btn btnlike"><i class="fa fa-heart fa-fw"></i>&nbsp; Noticias que te gustaron</a>
 <a type="button" href="EliminarPerfil.php?user=' . $iduserx . '" class="btn btneliminar"><i class="fa fa-trash fa-fw"></i>&nbsp; Eliminar perfil</a>
</div>
'; ?>
