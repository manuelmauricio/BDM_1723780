...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $idadmin = $_POST["idadmin"];
        ...
        $sql = "CALL sp_reportero('D','$id','null','null','null','null','null','null','null','null','null','null')";
...
<div id="main">
  <h2>¿Está seguro de que quiere dar de baja a este reportero?</h2>
...
<?php
$sql = "CALL sp_reportero('S','$id','null','null','null','null','null','null','null','null','null','null')";
 if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
 while($row = mysqli_fetch_array($result)){
    echo'<tr>
          <td class="w-25">
            <img src="data:image/jpg;base64,'.base64_encode($row["foto_perfil"]).'" class="img-fluid img-thumbnail" alt="producto">
          </td>
          <td>' . $row['nombres'] .  '  ' . $row['apellidos'] .  '  <br>' . $row['profesion'] . '</td>
        </tr>';
}
...
?>  
  ...
  <p>
  <button class="btn btnbackend" type="submit"><i class="fa fa-trash fa-fw"></i>&nbsp;&nbsp;Eliminar reportero</button>
<?php      echo'<a href="AdminListaReporteros.php?user=' . $iduserx . '" class="btn btnbackend" type="submit"><i class="fa fa-close fa-fw"></i>&nbsp;&nbsp;Cancelar</a>'; ?>  
