...
<div class="text-center" >
  <h1 style="color:  #2f435e; font-size: 400%; font-weight: 600;" >Último Minuto</h1>
  <hr class="titlehr" style="border:  4px solid #2f435e;">
</div>
...
echo '   
    ...
    <div class="carousel-item active">
      <img class="d-block w-100" src="data:image/jpg;base64,'.base64_encode($row["fotov"]).'" alt="First slide">
  <div class="carousel-caption d-none d-md-block">
    <h5 style="color:  #FFFFFF; font-size: 450%; font-weight: 600;" >' . $row['titulov'] . '</h5>
    <p style="color:  #FFFFFF; font-size: 120%; font-weight: 300;">' . $row['descripcionv'] . '</p>';
if ($iduserx == 0){
echo '    <a class="btn btn-lg btn-primary" style="color:  #FFFFFF; background-color: #44566c; border-color: #44566c;" href="Noticia.php?new=' . $row['idv'] . '">Leer más...</a>';
}
else{
echo '    <a class="btn btn-lg btn-primary" style="color:  #FFFFFF; background-color: #44566c; border-color: #44566c;" href="Noticia.php?user=' . $iduserx . '&new=' . $row['idv'] . '">Leer más...</a>';
...
<div class="col-xs-12" style="height:20px;"></div>
  ...
  <h2 style="color:  #44566c; font-size: 250%; font-weight: 500;">Noticias Recientes</h2>
  </div>
  <hr class="titlehr" style="border:  2px solid #44566c;">
