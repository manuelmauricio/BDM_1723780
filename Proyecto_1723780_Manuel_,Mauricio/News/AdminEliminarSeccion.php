...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $id = $_POST["id"];
        ...
        $sql = "CALL sp_seccion('D', ?, 'null','null','null','null','null');";
...
<div id="main">
  <h2>¿Está seguro de que quiere eliminar la siguiente sección?</h2>
...
<div class="container">
  ...
  <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
    ...
    <tr>
          ...
          <td><?php echo $descv; ?></td>
          <td>  <hr class="categhr" style="border:  20px solid <?php echo $colorv; ?>;"></td>
    </tr>
  ...
  <p>
  <button class="btn btnbackend" type="submit"><i class="fa fa-trash fa-fw"></i>&nbsp;&nbsp;Eliminar seccion</button>
   <?php      echo'<a href="AdminSecciones.php?user=' . $iduserx . '" class="btn btnbackend" type="submit"><i class="fa fa-close fa-fw"></i>&nbsp;&nbsp;Cancelar</a>'; ?>                  
                            </p>
                      </form>
