...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 $query = "CALL sp_publisnoticia('$currnew')";

                
if($stmt =  mysqli_query($link, $query)){
            
                header("location: AdminNoticias.php?user=$currus");
                exit();
            } else{
                echo "$currnew";
            }
...
<div id="main">
  <h2>¿Desea publicar esta noticia en el portal?</h2>
...
?>  
  ...
  <p>
  <button class="btn btnbackend" type="submit"><i class="fa fa-check fa-fw"></i>&nbsp;&nbsp;Publicar noticia</button>
<?php      echo'<a href="AdminNoticias.php?user=' . $iduserx . '" class="btn btnbackend" type="submit"><i class="fa fa-close fa-fw"></i>&nbsp;&nbsp;Cancelar</a>'; ?>  
